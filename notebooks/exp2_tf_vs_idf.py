# konsa model use karna chaiye ye batao 
import setuptools
import os
import re
import string
...
CONFIG = {
    "test_size": 0.2,
    "mlflow_tracking_uri": "https://dagshub.com/sayyedsabirali/capstone-project.mlflow",
    "dagshub_repo_owner": "sayyedsabirali",
...
if __name__ == "__main__":
    df = load_data(r'F:\capstone-project\notebooks\data.csv')
